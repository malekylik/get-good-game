...
export default class NameCountryByFlagImageTaskModalWindow extends TaskModalWindow {
    constructor(top = 0, left = 0, width = 0, height = 0, additionalResources = {}, parentComponent = null) {
        super(top, left, width, height, `Назови страну по флагу:`, additionalResources, parentComponent);
        ...
        const taskImage = additionalResources.images.nameCountryByFlagImage;
        ...
        this.answer = additionalResources.additional.nameCountryByFlag.answer;
    }
